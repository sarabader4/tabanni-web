...
export default function AIChatWidget() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: "assistant", content: "Hi! I'm Tabbani's AI assistant 🐾 I can help you find the perfect pet to adopt or foster, answer questions about the adoption process, or provide tips on pet care in Jordan. How can I help you today?" },
  ]);
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed bottom-24 right-6 z-50 w-[360px] rounded-2xl shadow-2xl overflow-hidden border border-gray-200 flex flex-col bg-white" style={{ height: "480px" }}>
          <div className="px-5 py-4 flex items-center gap-3" style={{ background: "#1E2A3A" }}>
            <div className="w-9 h-9 rounded-full flex items-center justify-center" style={{ background: "#FF6B35" }}>
