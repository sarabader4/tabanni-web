...
import { ArrowLeft, Loader2, Heart, Share2, CheckCircle2, Phone, User, Lightbulb, X, ShieldCheck } from "lucide-react";
        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              {pet.addedByAdmin && (
                <div className="inline-flex items-center gap-1.5 mt-2 px-3 py-1 rounded-full bg-[#3D937F] text-white text-xs font-bold shadow-sm">
