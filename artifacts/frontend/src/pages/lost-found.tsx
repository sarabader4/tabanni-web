            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5 mt-2">
              ...
              <div className="bg-white rounded-xl border border-gray-100 p-4 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input {...form.register("name")} placeholder={t("lostFound.placeholderName")} className={inputCls} />
                  ...
                  <div>
                    ...
                    <input {...form.register("breed")} placeholder={t("lostFound.breed")} className={inputCls} />
                  </div>

                  <div>
                    <label className={labelCls}>{t("lostFound.ageMonths")}</label>
                    <input type="number" min={0} {...form.register("ageMonths")} placeholder={t("lostFound.agePlaceholder")} className={inputCls} />
                    {form.formState.errors.ageMonths && <p className={errorCls}>{form.formState.errors.ageMonths.message}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    <input {...form.register("city")} placeholder={t("lostFound.cityPlaceholder")} className={inputCls} />
                  ...
                  <div>
                    ...
                    <input {...form.register("area")} placeholder={t("lostFound.areaPlaceholder")} className={inputCls} />
                  ...
                  <div className="sm:col-span-2">
                    ...
                    {reportType === "lost" ? (
                      <input type="date" {...form.register("lostDate")} className={inputCls} />
                    ) : (
                      <input type="date" {...form.register("foundDate")} className={inputCls} />
                    )}
              ...
              <div className="bg-white rounded-xl border border-gray-100 p-4 space-y-4">
                ...
                <div>
                  ...
                  <input {...form.register("reporterName")} placeholder={t("lostFound.reporterNamePlaceholder")} className={inputCls} />
