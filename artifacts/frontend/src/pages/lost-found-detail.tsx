              ...
              <div className="space-y-2.5">
                ...
                {whatsappLink && (
                  <a
                    ...
                    className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-xl bg-green-500 hover:bg-green-600 text-white font-bold text-sm transition-colors"
                  >
