...
import { 
  User, PawPrint, FileText, Heart, Bell, Users, MapPin, Settings, Edit2
} from "lucide-react";
...
export default function Profile() {
  ...
  const [form, setForm] = useState({
    fullName: "Ibrahim Bader",
    email: "bader4b@gmail.com",
    password: "",
    phone: "0799476182",
    country: "Jordan",
    city: "Amman",
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          >
            ...
            <div className="flex flex-col items-center mb-6 pt-2">
              <div className="w-16 h-16 rounded-full bg-gray-400 overflow-hidden mb-3">
                <img
                  src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=100&q=80"
                  alt="Profile"
                  className="w-full h-full object-cover"
                />
              </div>
              <p className="font-bold text-base">Ibrahim Bader</p>
              ...
              <>
                ...
                <div className="flex justify-center mb-8">
                  <div className="w-24 h-24 rounded-full bg-orange-100 overflow-hidden border-4 border-white shadow-lg">
                    <img
                      src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=200&q=80"
                      alt="Profile"
                      className="w-full h-full object-cover"
                    />
                  </div>
