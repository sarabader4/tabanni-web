...
export const ListAdoptionRequestsResponseItem = zod.object({
  ...
  petGender: zod.string().nullish(),
  petAgeMonths: zod.number().nullish(),
  petCity: zod.string().nullish(),
  petStory: zod.string().nullish(),
 ...
 */
export const UpdateGalleryPostParams = zod.object({
  id: zod.coerce.number(),
});
...
export const UpdateGalleryPostResponse = zod.object({
  id: zod.number(),
  title: zod.string(),
  headline: zod.string().nullish(),
  ownerName: zod.string().nullish(),
